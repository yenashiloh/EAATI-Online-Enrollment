                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <p>Reference No.: ' . htmlspecialchars($row['reference_number']) . '</p>
                                                            <p>Payment Method: ' . htmlspecialchars($row['payment_method']) . '</p>
                                                            <p>Payment Amount: ₱' . htmlspecialchars($row["payment_amount"]) . '</p>
                                                              <p>Balance: ₱' . htmlspecialchars($row["balance"]) . '</p>
                                                            <p>Payment Date: ' . htmlspecialchars($row["created_at"]) . '</p>
