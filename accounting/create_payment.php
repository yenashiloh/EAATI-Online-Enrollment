...
if (!isset($accounting_id)) {
    ...
    if (isset($_POST['add_payment'])) {
        ...
        $query->bindParam(':miscellaneous_fee', $miscellaneous_fee, PDO::PARAM_STR); // New field binding
                    ...
                    <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
                        ...
                        <form class="row g-3" method="post" name="add_payment" onSubmit="return valid();">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" class="form-control" id="miscellaneous_fee" name="miscellaneous_fee">
                            </div>
