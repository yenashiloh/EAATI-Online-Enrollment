		...
		<div class="left-side-bar">
			...
			<div class="menu-block customscroll">
				<div class="sidebar-menu">
                    ...
                    <li>
                        <a href="school_fees.php" class="dropdown-toggle no-arrow">
                        <span class="micon bi bi-wallet2"></span>
                            <span class="mtext">School Fees</span>
                        </a>
                    </li>
                    <li>
                        <a href="cor.php" class="dropdown-toggle no-arrow">
                            <span class="micon bi bi-file-earmark-text"></span>
                            <span class="mtext">Certificate of Registration</span>
                        </a>
                    </li>
                    <li>
                        <a href="grade.php" class="dropdown-toggle no-arrow">
